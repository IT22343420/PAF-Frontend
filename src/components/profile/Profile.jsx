    ...
    <div className="flex flex-col mt-5 w-[100%] max-w-[1200px]">
      <div className="flex flex-row items-center shadow-md rounded-md w-[100%] h-auto p-10">
        ...
        <div className="ml-5">
          ...
          <div className="flex flex-row">
            ...
            <div className="flex justify-center h-6 w-15 rounded-md bg-indigo-600 text-white m-2">
      ...
      <div className="flex flex-row mt-5">
        ...
        <NavLink
          to="/profile/sample1"
          className={({ isActive }) =>
            `flex justify-center items-center p-2 border-2 border-indigo-600 font-bold rounded-md ml-5 !no-underline ${
              isActive
                ? "text-white bg-indigo-600 hover:bg-indigo-500 hover:!text-white "
                : "text-gray-600 hover:!text-indigo-600 "
            }`
